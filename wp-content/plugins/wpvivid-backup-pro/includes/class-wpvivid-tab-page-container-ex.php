...
class WPvivid_Tab_Page_Container_Ex extends WPvivid_Tab_Page_Container
{
    ...
    public function display()
    {
        ...
        ?>
        <div class="wpvivid-one-coloum" id="<?php echo $this->container_id; ?>">
        ...
        <script>
            jQuery('#<?php echo $this->container_id?>').on("click",".<?php echo $this->container_id?>-tab",function()
            {
                ...
                jQuery('.<?php echo $this->container_id?>-content').each(function()
                {
                    jQuery(this).hide();
                });
            ...
            jQuery(document).ready(function($)
            {
                ...
                jQuery(document).on('<?php echo $this->container_id?>-delete', function(event,id,redirect)
                {
                    jQuery('#<?php echo $this->container_id?>').find( '.<?php echo $this->container_id?>-tab' ).each(function()
                    {
                        jQuery(this).removeClass( "nav-tab-active wpvivid-nav-tab-active" );
    ...
    public function display_tabs()
    {
        ...
        foreach ($this->tabs as $tab)
        {
            ...
            if(isset($tab['can_delete']))
            {
                echo '<span class="'.$span_class.'" style="'.$span_style.'"></span><span style="padding-right: 1em;">'.$tab['title'].'</span>';
                if(isset($tab['redirect']))
                {
                    echo '<div class="nav-tab-delete-img-addon" redirect="'.$tab['redirect'].'">
            ...
            {
                echo '<span class="'.$span_class.'" style="'.$span_style.'"></span><span>'.$tab['title'].'</span>';
            }
            echo '</a>';
        }
    }
