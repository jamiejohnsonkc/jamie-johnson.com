...
?>
<article class="container-fluid" id="i-optimize-marketing-performance">
	<!-- 	<div class="row"> -->
	...
	<!-- 		<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/01/endtoend-vert-1.13.19-01.svg" alt="" class="style-svg end2end"/> --></div>
