...
<div class="smm-sub-panel" id="expt-overlay-2">
	...
	<div class="expt-container">
		<div class="row expt-row">
			<div class="expt-vert">
				<div class="expt-vert-box">
					<div class="headline"><h2>Strategic Marketing Management</h2>
					</div>			
		...
		<div class="expt-menu-horz">
			<div class="row">
				...
				<div class="expt-menu-box" id="open-expt-overlay-3">
					<div class="expt-menu-icon"><img src="http://jamiejohnsonmev2.test/wp-content/uploads/2018/12/skills_25.svg" class="style-svg" alt="skills_icon"/></div>
				...
				<div class="expt-menu-box" id="open-expt-overlay-5">
					<div class="expt-menu-icon"><img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/01/skills_31.svg" class="style-svg" alt="skills_icon"/></div>
