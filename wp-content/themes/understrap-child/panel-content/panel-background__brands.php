		...
		<div class="article article__container article__container--brands brands__article-container">
			...
			<div class="wrapper wrapper__grid--brands brands__grid-wrapper">
				<div class="flexbox-grid flexbox-grid__container--brands container--brands-history background__brands_content brands__grid-container">
					<div class="flexbox-grid__cell--image flexbox-grid__first-cell">
						<p class="copy copy__container copy__header brands__copy-header">Every experience taught me something about marketing, the nature of business and how to get the most (and in some cases the least) from every marketing dollar.</p>
					</div>
