...
<article class="article__wrapper-fluid splash-wrapper bgshoes">
		<div class="container splash background__container_splash" id="background__splash">
	<!-- 	<h1>About Me</h1> -->
		<div class="splash__content_container splash__content_container--background">
		<h1>About Me</h1>
		
		<h3>20 years in marketing &mdash; with the liver to prove it.</h3>
