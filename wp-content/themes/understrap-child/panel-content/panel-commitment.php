			...
			<div class="content__container commitment__content_container">
				<div class="commitment__flex-item">
					<div class="commitment__subhead_container">
						<h3 class="commitment__subhead">I work for you</h3>
					</div>
					<p class="commitment__body_copy"><span class="leader">You call the shots. </span>I'm as comfortable making recommendations as I am taking direction. Whether you need C-level strategy or a spare set of hands, I can help.</p>
					<p class="commitment__body_copy"><span class="leader">Get what you need. No more. No less.</span>I believe what comes around goes around. I just want to make your day a little easier.</p>
					<p class="commitment__body_copy"><span class="leader">I never forget who pays the bills.</span> If you want my opinion, you'll have it. If you want recommendations, you'll get them. If you want me to shut up and just do what I'm told, just say so.</p>
				</div>
				<hr class="hr__commitment">
				<div class="commitment__flex-item">
					<div class="commitment__subhead_container">
						<h3 class="commitment__subhead">I Don't Do Surprises</h3>
					</div>
					<p class="commitment__body_copy"><span class="leader">Clarity from the outset. </span> I promise you a written scope of work, estimated cost, development schedule and restatement of direction prior to work commencing.</p>
					<p class="commitment__body_copy"><span class="leader">Pre-approved expenses. </span> No cost, deadline or direction will be altered or overran without your prior knowledge.</p>
				</div>
				<hr class="hr__commitment">
				<div class="commitment__flex-item">
					<div class="commitment__subhead_container">
