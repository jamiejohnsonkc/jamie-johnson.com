            ...
            <div class="flex-item__wrapper">
              ...
              <div class="flex-item">
                <div class="flex-headline">
                  <div class="headline__box">What i do</div>
                  <h2 class="headline">I grow business</h2>
                </div>
              ...
              <div class="flex-item">
                <div class="flex-headline">
                  ...
                  <h2 class="headline">By the most efficient means possible</h2>
                </div>
                <p class="copy">I'm discipline neutral and strategically impartial. The right scale, the right scope and the right solution for your business is all that matters.</p>
              </div>

              <div class="flex-item">
                <div class="flex-headline">
                  <div class="headline__box">Who i work with best</div>
                  <h2 class="headline">Young & Emerging Businesses</h2>
                </div>
                <p class="copy">Why? 1) They need a generalist like me that can help with the big picture and the nitty gritty. 2)They're the most fun.</p>
              </div>

              <div class="flex-item">
                <div class="flex-headline">
                  <div class="headline__box">Where I Add Value</div>
                  <h2 class="headline">At the Corporate, business, or function level</h2>
                </div>
                <p class="copy">I've planned new market entries, built marketing departments, put logos on coffee mugs and most everything else in between.</p>
                <p class="copy">I'm as comfortable at the whiteboard talking long-term C-level strategy as I am pushing pixels.</p>
              </div>

              <div class="flex-item">
                <div class="flex-headline">
                  <div class="headline__box">Why Me</div>
                  <h2 class="headline">Strategy + Technology + Creativity</h2>
                </div>
                <p class="copy">i'm a generalist in a sea of specialist.</p>
                <p class="copy">Aute aute ex consequat sunt id officia.</p>
              </div>
        ...
        <div class="flex-container">
          ...
          <div class="flex-item__a">
            ...
            <div class="flex-element">
              <h4 class="subhead">strategic marketing management</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>

            <div class="flex-element">
              <h4 class="subhead">marketing communications</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>

            <div class="flex-element">
              <h4 class="subhead">marketing operations</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>
          </div>
          ...
          <div class="flex-item__b">
            ...
            <div class="flex-element">
              <h4 class="subhead">planning & strategy</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>

            <div class="flex-element">
              <h4 class="subhead">web design & development</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>
            ...
            <div class="flex-element">
              <h4 class="subhead">creative services</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>
          </div>
          ...
          <div class="flex-item__c">
            ...
            <div class="flex-element">
              <h4 class="subhead">Consultation</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>

            <div class="flex-element">
              <h4 class="subhead">Implementation</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>

            <div class="flex-element">
              <h4 class="subhead">Execution</h4>
              <p class="copy">Lorem do nisi sunt labore fugiat.Ipsum officia id enim proident proident qui.</p>
            </div>
...
<!--
					...
					<p class="copy">What do I do? I help businesses grow. That's it.</p>
					<p class="copy">Whether you need a business plan, marketing strategy, organizational design, a new website or marketing materials, I can help you.</p>

					who i work for
					<h3 class="subhead">for young and emerging businesses</h3>
					<p class="copy">Ex aute excepteur ullamco velit occaecat nostrud consequat adipisicing qui labore.</p> -->
...
<!-- <div class="flex-item">
					<h1 class="pagination">what i do</h1>
					<h2 class="headline">Integrative Marketing</h2>
					<h3 class="sublist">strategic marketing management | digital & traditional marcom | marketing operations</h3>
				</div>
				<div class="flex-item">
					<p class="copy">Management consultants promise the world just before they leave. Creative services, well they create things. Nevermind trying to keep up with the web guys. On top of that who's watching the big picture for you?</p>
					<p class="copy">There are two universal marketing truths today.  1. It's getting complicated. 2. There is less and less of you to go around.</p>
...
<article class="modern-marketing-management" id="modern-marketing-management">
    ...
    <div class="flex-container growth__content-intro">
      ...
      <div class="growth__content-item growth__content-item--summary">
        <div class="growth__content-item-wrapper">
          ...
          <a href="#competitive" class="button ui-button__jump growth-article__link--jump" title="read more"><?php get_template_part('buttons/button', 'jump'); ?></a>
        </div>
      </div>
      <div class="growth__content-item growth__content-item--competitive" id="competitive">
        ...
        <div class="growth__content-item--container growth__content--light">
          ...
          <div class="growth__grid-item-header">Get <br>Competitive</div>
        ...
        <a href="#found" class="button ui-button__jump" title="read more"><?php get_template_part('buttons/button', 'jump'); ?></a>
      </div>
      ...
      <div class="growth__content-item growth__content-item--found" id="found">
        ...
        <div class="growth__content-item--container growth__content--light">
          ...
          <div class="growth__headline--prehead">I can help you</div>
          <div class="growth__grid-item-header">Get <br class="br__growth-grid-item-header">Found</div>
          <div class="copy__block growth__grid-item-copy">Don't go to the market. Bring the market to you.</div>
        ...
        <a href="#sold" class="button ui-button__jump" title="read more"><?php get_template_part('buttons/button', 'jump'); ?></a>
      ...
      <div class="growth__content-item growth__content-item--sold" id="sold">
        ...
        <div class="growth__content-item--container growth__content--light">
          ...
          <div class="copy__block growth__grid-item-copy">But don't just sell. Help.</div>
          <!-- <div class="copy__header growth__copy-header">Consectetur elit labore esse nisi cupidatat ad occaecat cillum cillum.</div> -->
          <div class="button overlay__button growth__overlay-button">earn trust</div>
        </div>
        <a href="#more" class="button ui-button__jump" title="read more"><?php get_template_part('buttons/button', 'jump'); ?></a>
      ...
      <div class="growth__content-item growth__content-item--more " id="more">
        ...
        <div class="growth__content-item--container growth__content--light">
          ...
          <div class="copy__block growth__grid-item-copy">More business. More ROI. <br>You know. More.</div>
          <!-- <div class="copy__header growth__copy-header">Consectetur elit labore esse nisi cupidatat ad occaecat cillum cillum.</div> -->
          <div class="button overlay__button growth__overlay-button">optimize performance</div>
        </div>
        <a href="#communications" class="button ui-button__jump" title="read more"><?php get_template_part('buttons/button', 'jump'); ?></a>
