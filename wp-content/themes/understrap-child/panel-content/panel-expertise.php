	...
	<div class="container" id="exptcontainer">
		...
		<!-- 			<li data-target="#post-sub-panel" data-slide-to="0" class="active">Post-Digital Marketing</li>
			...
			<div class="expt-skills">
					...
					<div class="carousel-item"><div class="exptblock" id="smm-sub-panel">
					...
					<div class="carousel-item"><div class="exptblock" id="marcom-sub-panel">
						...
						<div class="exptbox">
								<div class="expt-icon">
									<img class="style-svg" src="http://jamiejohnsonmev2.test/wp-content/uploads/2018/12/skills_17.svg" alt="skill icon" />
								</div>
								<div class="expt-copy">
									<h6>Outbound</h6>
