...
<h1>how i do it</h1>
				<div class="page-head__howidoit">
				
				
				<h2>Soup to Nuts.</h2>
			
					<!-- 	<h3>leadership | strategy | design | development | ops</h3>   --><!-- sublist!!! -->
					<h3>From the board room to your home page and everything in between.</h3>
	...
	<div class="content-container">
					...
					<div class="content1">
					<div class="quote" id="quote__open">&#8220;</div><h4>I've been strategizing, creating and managing marketing initiatives my entire career.</h4>
					<h4>So whether you're a fortune 500 or just getting started, I can bring value to your business.</h4><h4>If not, I'll help you find someone who can.</h4><div class="quote" id="quote__close">&#8221;</div>
				</div>
				<div class="content2">

	<div class="howidoit__disciplines">
				<div class="howidoit__disciplines_content" id="col-offset"><h2>Soup to Nuts.</h2>
					<h3>From the board room to your home page and everything in between.</h3></div>
				<div class="howidoit__disciplines_content"><!-- make column --> <!--  flex-col -->
					...
					<div class="howidoit__disciplines_content--description"><h5>strategic <span class="br"><br></span> leadership</h5>
						<p>identifying paths to augment business performance & growth</p></div>
				</div>
					<div class="howidoit__disciplines_content"><!-- make column --> <!--  flex-col -->
					...
					<div class="howidoit__disciplines_content--description"><h5>marketing <span class="br"><br></span>management</h5>
					<p>creating and retaining customers</p></div>
				</div>
				<div class="howidoit__disciplines_content"><!-- make column --> <!--  flex-col -->
				...
				<div class="howidoit__disciplines_content--description"><h5>marketing <span class="br"><br></span>communications</h5>
				<p>earning and maintaining customer trust</p></div>
			</div>
			<div class="howidoit__disciplines_content"><!-- make column --> <!--  flex-col -->
			...
			<div class="howidoit__disciplines_content--description"><h5>digital design & development</h5>
				<p>engaging and converting prospects</p></div>
			</div>
			<div class="howidoit__disciplines_content"><!-- make column --> <!--  flex-col -->
			...
			<div class="howidoit__disciplines_content--description"><h5>operations <span class="br"><br></span>& infrastructure</h5>
			<p>optimizing marketing process, systems and technology</p></div>
		</div>
	</div>
</div>
</div>
