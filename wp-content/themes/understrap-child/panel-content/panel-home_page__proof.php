...
<!-- 				<h2 class="proof__page_headline">Four Big Reasons You Should Hire <br class="br__proof--me">Me</h2> -->
				...
				<div class="proof__page_headline--alternate">
					...
					<div class="proof__page_headline--line7">ME</div>
						<img src="//jamiejohnsonmev2.test/wp-content/uploads/2019/04/arrow-up.svg" class="style-svg arrow-dwn-svg" alt="...">
				</div>
			...
			<div class="proof__panel_wrapper">
				...
				<div class="proof__marketer_panel proof__panel_wrapper--border">
					...
					<div class="proof__content_outcomes" id="idooutcomes">
						<h5 class="headline headline__header headline--proof proof__panel_headline">I do outcomes. <span class="br"><br></span>Not overhead.</h5>
						<div class="proof__content_text proof__content_text_idooutcomes"><p class="copy__header copy__header--serif copy__header--proof proof__panel_body-copy">It's been my experience there are two types people in my line of work &mdash; spenders &amp; marketers.</p><p class="copy__header copy__header--serif copy__header--proof proof__panel_body-copy">Spenders generate rudderless overhead. Marketers find ways to achieve strategic business objectives.</p><p class="copy__header copy__header--serif copy__header--proof proof__panel_body-copy"><em> I'm a Marketer.</em></p></div>
...
<div class="copy__header proof__panel_body-copy copy__header--proof copy--stats">Ut id culpa minim commodo officia ut non et sed amet magna cupidatat dolor fugiat est ut id enim.</p></div>
				</div>
		...
		<div class="proof__panel_wrapper">
			<div class="content__item_col proof__item_container proof__item_container--centricity">
				...
				<div class="proof__content_centricity content__item_caption" id="proof__you">
					...
					<h5 class="headline headline__header proof__panel_headline headline headline__header proof__panel_headline--centricity">It's You. Not Me.</h5>
					<div class="proof__content_text proof__content_text--centricity"><p class="copy__header proof__panel_body-copy copy__header proof__panel_body-copy--centricity">I believe professional services should be professional about service.</p></div>
