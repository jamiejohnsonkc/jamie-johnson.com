			...
			<div class="proof__panel_wrapper">
				<div class="proof__end2end_panel">
					...
					<div class="proof__end2end-diagram_container" id="end2end__diagram_container">
											<div class="proof__panel_intro">@</div>
						<h5 class="proof__panel_headline">End to End Expertise</h5>
						<h6 class="proof__panel_subhead proof__panel_subhead--end2end">From the Board Room to the Keyboard</h6>
						...
						<div class="proof__content_text proof__content_text--end2end"><p class="proof__panel_body-copy">I can scheme it, design it and execute it. That lowers cost and improves performance which means more cheddar for you.</p></div>
					</div>
				</div>
			</div>
			<div class="proof__panel_wrapper proof__panel_wrapper--stats">
				<div class="proof__stats_panel">
					<div class="proof__panel_intro proof__panel_intro--stats">#</div>
					<div class="proof__content_carousel carousel slide" id="stats-slider" data-interval="false">
						<h5 class="proof__panel_headline proof__panel_headline--stats">i've been around</h5>
							...
							<div class="carousel-item one-up active">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_11.svg" class="style-svg" id="brands" alt="First slide"/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">brands supported</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_09.svg" class="style-svg" id="verticals" alt="Second slide"/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">categories served</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_13.svg" class="style-svg" id="calendar" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">years of experience</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_12.svg" class="style-svg" id="agency" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">agency</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_14.svg" class="style-svg" id="corporate" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">corporate</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									...
									<div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">largest program</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_10.svg" class="style-svg" id="p&l" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">operations responsibility</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_04.svg" class="style-svg" id="globe" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">largest employer</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">p
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_05.svg" class="style-svg" id="atom" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">tiniest employer</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_01.svg" class="style-svg" id="matrix" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">matrix reports</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_02.svg" class="style-svg" id="direct" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">direct reports</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_03.svg" class="style-svg"					 id="accessible" 		alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">user friendly</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item one-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_08.svg" class="style-svg" id="bs" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead">bullshit</h6>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="carousel-inner three-up-carousel">
							<div class="carousel-item row no-gutters three-up active">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_11.svg" class="style-svg" id="brands" alt="First slide"/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">brands supported</h6>
									</div>
								</div>
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_09.svg" class="style-svg" id="verticals" alt="Second slide"/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">categories served</h6>
									</div>
								</div>
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_13.svg" class="style-svg" id="calendar" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">years of experience</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item row no-gutters three-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_12.svg" class="style-svg" id="agency" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">agency</h6>
									</div>
								</div>
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_14.svg" class="style-svg" id="corporate" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">corporate</h6>
									</div>
								</div>
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_06.svg" class="style-svg" id="purse" alt="..."/>
									<div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">largest program</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item row no-gutters three-up">
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_10.svg" class="style-svg" id="p&l" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">operations responsibility</h6>
									</div>
								</div>
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_04.svg" class="style-svg" id="globe" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">largest employer</h6>
									</div>
								</div>
								<div class="proof-quals">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_05.svg" class="style-svg" id="atom" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">tiniest employer</h6>
									</div>
								</div>
							</div>
							<div class="carousel-item row no-gutters three-up">
								<div class="proof-quals" id="odd-stats">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_01.svg" class="style-svg" id="matrix" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">largest team</h6>
									</div>
								</div>
								<div class="proof-quals" id="odd-stats">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_03.svg" class="style-svg" id="accessible" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">user friendly</h6>
									</div>
								</div>
								<div class="proof-quals" id="odd-stats">
									<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2019/03/stats_08.svg" class="style-svg" id="bs" alt="..."/><div class="stats-caption carousel-caption">
										<h6 class="proof__panel_subhead proof__panel_subhead--stats">bullshit</h6>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="proof__content_text proof__content_text--stats"><p class="proof__panel_body-copy proof__panel_body-copy--stats">Ut id culpa minim commodo officia ut non et sed amet magna cupidatat dolor fugiat est ut id enim.</p></div>
			</div>
		</div>
		<div class="proof__panel_wrapper">
			<div class="content__item_col proof__item_container proof__item_container--centricity">
				...
				<div class="proof__content_centricity content__item_caption" id="proof__you">
									<h2 class="proof__panel_intro proof__panel_intro--centricity">$</h2>
					<h5 class="proof__panel_headline proof__panel_headline--centricity">It's You. Not Me.</h5>
					<div class="proof__content_text proof__content_text--centricity"><p class="proof__panel_body-copy proof__panel_body-copy--centricity">I believe professional services should be professional about service.</p></div>
