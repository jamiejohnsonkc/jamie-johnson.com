...
?>
<section class="section atypical__section">
		...
		<div class="content-container">
			<div class="content1">
				<div class="atypical__intro">
					<div class="pagination justification__pagination"><div class="pagination">atypical</div></div>
			...
			<div class="content2">
				...
				</div>	<a class="link link__chevron" href="http://jamiejohnsonmev2.test/modus-operandi#i-advance-business-objectives" title="go to next">
			<img src="/wp-content/uploads/2018/12/chevdn.svg" alt="chevron pointing down" class="chev--dwn style-svg link__advance_chev-dwn"/></a>
		</div>
	</div>
</article>
</section>