...
<section class="proof__section" id="proof-of-claim">
	...
	<article class="proof__article--wrapper outcomes__article-wrapper">
		...
		<div class="proof__content-container outcomes__content-container">
			...
			<div class="proof__content_item_img outcomes__image"><img src="/wp-content/uploads/2019/01/evolutionv2-small.jpg" class="evo2small" alt="image of lego figures evolving"></div>
	...
	<article class="proof__article--wrapper end2end__article-wrapper">
		...
		<div class="proof__content-container end2end__content-container">
			...
			<div class="diagram diagram__end2end diagram__end2end--vert diagram__container--end2end">
				...
				<div class="end2end__diagram_img"><img src="/wp-content/uploads/2018/12/skills_11.svg" class="style-svg" alt="increasing earnings chart icon"></div>
			</div>
