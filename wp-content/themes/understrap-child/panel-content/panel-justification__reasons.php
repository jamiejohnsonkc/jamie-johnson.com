...
<section class="section--reasons">
	<article class="article__wrapper article__wrapper--reasons content__wrapper justification"> <!-- CONTAINER -->
	...
	<article class="article__wrapper article__wrapper--reasons content justification"> <!-- CONTAINER -->
...
<div class="diagram__header diagram__header--reasons">
						<p class="deck deck__header deck__header--reasons deck__header--value">The defining characterstic of post-digital is not digital technology.</p><p class="justification__page-header_text deck__header--value">It's the inversion of buyer &amp; seller relationship dynamics.</p>
						...
						<div class="read-more__container read-more__value">
							<div class="justification__conclusion justification__conclusion--background" id="value__conclusion_cultivate"><p class="body__text_lg">Competitive dynamics are evolving. Customers don't want posturing, they want substance and authenticity.</p><p class="body__text_lg">Before you can generate revenue you have to get found then you have to win their trust. You have to really know your customer and more importantly, be honest about your offering.</p>
							</div>
						</div>
						<a class="link link__chevron" href="http://jamiejohnsonmev2.test/modus-operandi#i-advance-business-objectives" title="go to next">
							<img src="http://jamiejohnsonmev2.test/wp-content/uploads/2018/12/chevdn.svg" alt="..." class="chev--dwn style-svg" id="link__advance_chev-dwn"/>
	...
	<article class="article__wrapper article__wrapper--reasons content__wrapper justification"> <!-- CONTAINER -->
				...
				<div class="container business-value justification__containerjustification__container_modernize" id="modernize">
						...
						<div class="header-25x75row__container">
							...
							<h3 class="header-25x75row__row2 header-25x75row__row2--custom-headline">I <br class="br__modernize--diagram">modernize <br class="br__modernize--diagram">marketing</h3></div>
