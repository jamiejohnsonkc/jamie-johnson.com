...
<article class="article__wrapper  my-expertise skills">
	<div class="container my-expertise my-expertise__container__skills">
		...
		<div class="expertise__overlay expertise__overlay--marketing-management" id="expt-overlay-2">
			<div id="expt-close-2"><div>X</div></div>
			<div class="overlay__container">
				...
				<div class="overlay__content">
					...
					<h3>Strategy</h3>
					<ul><li>Product/Service Management</li>
