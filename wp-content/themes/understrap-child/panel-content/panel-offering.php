 		...
 		<div class="flex-container offering__content-container offering__content-intro">
 			...
 			<div class="offering__content-item offering__content-item--grow" id="grow">
 				...
 				<div class="offering__content-item--container"> 
 					...
 					<div class="offering__copy-container">
 						...
 						<!-- <p class="copy">value design</p>
 						<p class="copy">customer experience</p>
 			...
 			<div class="offering__content-item offering__content-item--engage" id="engaging">
 				...
 				<div class="offering__content-item--container offering__content--light">
 					...
 					<div class="offering__copy-container">
 						<p class="copy">Digital and analog design and development, creative services and program management to transform strategy into kinetic customer engagement.</p>
...
<article class="belief" id="beliefs">
 				...
 				<div class="flex-container">
 					<div class="flex-item flex-item__a">
 						...
 						<p class="copy">But it quite nicely sums up my point of view: marketing should do more than look pretty&mdash; it better be making you money.</p>

 						<a class="link link__text link__text--offering offering__link" href="/better">&#8250;See How I Make Marketing Better</a>
 					</div>
