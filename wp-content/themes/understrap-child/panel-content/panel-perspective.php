...
?>
<section class="flex-section__marketing">
			...
			<div class="flex-container">
				...
				<div class="flex-item flex-item__a">
					<div class="header__container">
						<h3 class="headline">1. everything has changed</h3> 
						<div class="expand-button__comtainer"><a href="#paradigm-evolve" class="ui-button ui-button__expand expand-button--perspective" id="expand-paradigm" title="read more"><?php get_template_part('buttons/button', 'expand'); ?></a></div>
					</div>
					
					<div class="container__accordion container__accordion--evolve" id="paradigm-evolve">
					<p class="copy">(trigger warning: reality) The modern customer runs the show. They have more options. They're informed. They don't want to be bothered. They have social media and aren't afraid to use it.</p> 
<p class="copy">The days of interruptive, self-aggrandizing promotion and lackluster performance are in their twilight.</p>
<p class="copy">Today it's all about transparency and authenticity. If you make a promise, you better keep it.</p>
				...
				<div class="flex-item flex-item__c">
					<div class="header__container">
						<h3 class="headline">3. it's time marketing services evolved too</h3> 
						<div class="expand-button__comtainer"><a href="#time-evolve" class="ui-button ui-button__expand expand-button--perspective" id="expand-time" title="read more"><?php get_template_part('buttons/button', 'expand'); ?></a></div>
					</div>
