	...
	<div class="container home-page__howidoit__container"> -->
		<article class="article__wrapper content__wrapper commitment__article_wrapper" id="article__wrapper--services-exit">
			<div class="container commitment__article_container"  id="article__container--services-exit">
				...
				<h2 class="commitment__headline">A Few Points About How I Conduct Business</h2>
				...
				<div class="content__container commitment__content_container">
					...
					<p class="commitment__body_copy"><span class=" commitment__body-copy--leader">You decide the scope, role and level of my participation.</span> Give me a challenge to address, an objective to achieve, a task to complete or instructions to execute. It's your call. I'm comfortable supporting, contributing or even managing efforts on your behalf.</p>
					<p class="commitment__body_copy"><span class=" commitment__body-copy--leader">You decide my level of involvement.</span> I am available for freelance, part-time and contract (short-term) engagements. My services are available via consultation, facilitation or execution.</p>
					<p class="commitment__body_copy"><span class=" commitment__body-copy--leader">You pay the bills.</span> If you want my opinion, you'll have it. If you want recommendations, you'll get them. If you want me to shut up and just do what I'm told, just say so.</p>
					...
					<p class="commitment__body_copy"><span class=" commitment__body-copy--leader">I do not charge by the hour </span> (spare a few exceptions). I expect to be compensated relative to the value I bring to your effort not the time spent at your expense.</p>
					...
					<p class="commitment__body_copy"><span class=" commitment__body-copy--leader">I have nothing to prove.</span> If I ever did, it was done a long time ago. My only motivation is to deliver value.</p>
					<p class="commitment__body_copy"><span class=" commitment__body-copy--leader">I know my limits.</span> I'm good at what I do, but no one is good at everything. If I'm not right for the job, I'll tell you.</p>
