...
?>
		<article class="article__wrapper content__wrapper services">
			<div class="article__head container content__container_col">
				...
				<div class="content__container">
						<div class="content__item_col " id="">
							...
							<div class="content__item_caption">
								<p>In ut in duis incididunt pariatur sunt voluptate dolor minim veniam voluptate excepteur irure in proident magna ut in minim dolore ut deserunt dolore quis quis cupidatat elit enim.</p>
								<p>Ut ad dolor incididunt enim occaecat sed non eu quis pariatur.</p>
							
							
							
						<div class="services__list" id="services__list--disciplines">
						<h4>Core Service Areas</h4>
							<ol>
								<li><a href="/">Mobile + Web Development</a></li>
								<li><a href="/">Integrated Communications</a></li>
								<li><a href="/">Strategic Marketing Management</a></li>
							</ol>
						</div>
					</div>
