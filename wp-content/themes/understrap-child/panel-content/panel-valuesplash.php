...
<article class="cover-container register" id="val-splash">
	...
	<div class="container" id="val-splash-container">
		
		<div class="headline"><h1>I Deliver Value </h1></div>
		
		<div class="splash-1" id="val-splash-1">"marketing is a means, not the end" &mdash;me </div>
		
		<div class="splash-2" id="val-splash-2"><span class="indentspan">business acumen</span> <span class="br"><br></span><span class="hidespan">+</span> <span class="indentspan">marketing savvy</span> <span class="br"><br></span><span class="spanunderline">+ <span class="indentmorespan">customer centricity</span></span> <span class="br"><br></span>= <span class="indentmorespan">better business</span></div>
		<a class="advance-link" href="//localhost:3000/valdus-operandi#i-advance-business-objectives" title="go to next">
	...
	<article class="cover-fluid intro" id="val-intro">
		...
		<div class="page-title">
				<hr>
				<span>my m.o.</span>
			</div><div class="headline"><h2>I create assets not overhead</h2></div>
		<div class="display-text">I combine strategic frameworks, technology and operations to effect marketing that behaves and performs like a business function and less of an administrative activity.</div>
